...
onready var _condition = $CenterContainer/VBoxContainer/condition
onready var _message = $CenterContainer/VBoxContainer/message

onready var _airship_destroy = $CenterContainer/VBoxContainer/VBoxContainer/HBoxContainer/airship_destroy
onready var _fort_destroy = $CenterContainer/VBoxContainer/VBoxContainer/HBoxContainer2/fort_destroy
